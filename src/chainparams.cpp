...
{
    const char* pszTimestamp = "Jolofcoin was created on this day of 01 January 2021";
    const CScript genesisOutputScript = CScript() << ParseHex("090184710fa689ad7983690c80f3a49c8f11f8d45b8c857fbcbc8bc4a8e4d3eb4b10f2d4604fa08dce513aaf0f470216fe1b51810b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1609394340, 2001020468, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x53a968b4230823010f4a0c96f377943f90eafd248d9acbb2247808a372920e84"));
        assert(genesis.hashMerkleRoot == uint256S("0x00d3dcb16ef391b382194ee5e1ee2227f1fbc6e45c1a325004dc4d67f41a6872"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("34.150.139.249", "34.150.139.249", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("jolofcointools.com", "dnsseed.jolofcointools.com"));
        //vSeeds.push_back(CDNSSeedData("jolofcoinpool.org", "dnsseed.jolofcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x53a968b4230823010f4a0c96f377943f90eafd248d9acbb2247808a372920e84"))
        ...
        chainTxData = ChainTxData{
            ...
            1609394340, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1609394340, 2906857, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3a16b3c10f071bee9c2acc1d9477c18df28634b0fff098d5e58f15f6ea8b9cbc"));
        assert(genesis.hashMerkleRoot == uint256S("0x00d3dcb16ef391b382194ee5e1ee2227f1fbc6e45c1a325004dc4d67f41a6872"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("34.150.139.249", "34.150.139.249"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.jolofcoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x3a16b3c10f071bee9c2acc1d9477c18df28634b0fff098d5e58f15f6ea8b9cbc")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1609394340, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf8256daac846339ff70c38203f9efa84b7ffad1b9ba2e9c155c5d805215e9d36"));
        assert(genesis.hashMerkleRoot == uint256S("0x00d3dcb16ef391b382194ee5e1ee2227f1fbc6e45c1a325004dc4d67f41a6872"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xf8256daac846339ff70c38203f9efa84b7ffad1b9ba2e9c155c5d805215e9d36"))
        };
