...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s jolofcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  jolofcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jolofcoin transaction") + "\n" +
              "  jolofcoin-tx [options] -create [commands]   " + _("Create hex-encoded jolofcoin transaction") + "\n" +
              "\n";
