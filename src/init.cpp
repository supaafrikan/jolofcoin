...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/jolofcoin-project/jolofcoin>";
    const std::string URL_WEBSITE = "<https://jolofcoin.org>";
